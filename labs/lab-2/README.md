...
В данной лабораторной работе необходимо написать два docker-compose: плохой, который соответствует плохим практикам, и хороший, в котором плохие практики были исправлены. Для демонстрации работы контейнеров используются приложения из первой лабораторной работы (скрипты на Python, реализующие бэкенд и фронтенд).
