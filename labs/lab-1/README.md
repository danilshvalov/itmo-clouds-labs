...
Выводу по результатам сканирования (помимо уже известных данных, например, версий Nginx, ОС и т.д.):
